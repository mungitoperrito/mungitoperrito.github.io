...
- [AI Typing assistant](https://github.com/mungitoperrito/python-projects/blob/main/scripts/ai_typing_assistant.py)
- [Arithmetic worksheet generator](https://github.com/mungitoperrito/python-projects/blob/main/scripts/simple_arithmetic.py)
- [Birthday paradox stats generator](https://github.com/mungitoperrito/python-projects/blob/main/scripts/paradox.py)
- Bug investigation
...
- GitLab
  ...
  - [Collect runner diagnostics](https://github.com/mungitoperrito/python-projects/blob/main/scripts/gitlab_runner_diagnostic.py)
- [Property based testing](https://github.com/mungitoperrito/python-projects/blob/main/scripts/property_based_testing.py)
  and some [tests](https://github.com/mungitoperrito/python-projects/blob/main/scripts/test_property_based_testing.py)
- Selenium
