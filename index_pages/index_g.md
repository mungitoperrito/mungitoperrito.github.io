...
-  [`git`](../notes_pages/notes_g.md#git)
    ...
    -  [Shortcuts](../notes_pages/notes_g.md#shortcuts)
    -  [Use a different `ssh` key](../notes_pages/notes_g.md#use-a-different-ssh-key)
...
-  [Google search](../notes_pages/notes_g.md#google-search)
    ...
    -  [Search operators](../notes_pages/notes_g.md#search-operators)
