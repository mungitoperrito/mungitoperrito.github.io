...
-  [Bash scripting](../notes_pages/notes_b.md#bash-scripting)
    ...
    -  [Evaluate an expression](../notes_pages/notes_b.md#evaluate-an-expression)
    ...
    -  [Strip a filename prefix](../notes_pages/notes_b.md#strip-a-filename-prefix)
...
-  [BIOS](../notes_pages/notes_b.md#bios)
    -  [Common memory locations](../notes_pages/notes_b.md#common-memory-locations)
    -  [Startup order](../notes_pages/notes_b.md#startup-order)
